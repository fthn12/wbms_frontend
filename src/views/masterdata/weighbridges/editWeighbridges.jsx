...
const EditWeighbridges = ({ isEditOpen, onClose, dtSites, dtWeighbridges }) => {
  ...
  const handleFormSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      await WeighbridgesAPI.update(values);
...
export default EditWeighbridges;
